...
// Clean up old sessions and create new ones
const cleanAndCreateSessions = async () => {
  try {
    ...
    if (subscriptions.length === 0) {
      console.log('❌ No active subscriptions found. Creating test subscriptions...');
      ...
      if (coaches.length === 0 || users.length === 0) {
        console.log('❌ No coaches or users found');
        return;
      }
    ...
    // Now create sessions for the next 5 days
    console.log('🎯 Creating sessions for the next 5 days...');
